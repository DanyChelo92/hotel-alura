...
public class RegistroHuesped extends JFrame {
	...
	private void guadarHuesped() {
		if (txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
		    ...
		    int nro_reserva= Integer.parseInt(txtNreserva.getText());
		    Huesped huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), fechaN,
		    txtNacionalidad.getSelectedItem().toString(),txtTelefono.getText(),nro_reserva);
		    this.cont_huesped.guardar(huesped);
