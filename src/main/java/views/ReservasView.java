...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate()!=null 
			...
			LocalDate fecha_entrada=LocalDate.parse(((JTextField)txtFechaEntrada.getDateEditor()).getText());
			LocalDate fecha_salida=LocalDate.parse(((JTextField)txtFechaSalida.getDateEditor()).getText());
			Reserva reserva=new Reserva(fecha_entrada,fecha_salida,txtValor.getText(),txtFormaPago.getSelectedItem().toString());
			cont_reserva.guardar(reserva);
	...
	public void calcularValor(JDateChooser fecha_entrada,JDateChooser fecha_salida) {
		if (fecha_entrada.getDate()!=null && fecha_salida.getDate()!=null) {
			if(fecha_entrada.getDate().after(fecha_salida.getDate())){
